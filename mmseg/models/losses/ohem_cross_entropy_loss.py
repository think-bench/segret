...
class OhemCrossEntropy(nn.Module):
    ...
    def forward(self, score: Tensor, target: Tensor, weight=1.0, ignore_index=255) -> Tensor:
        """Forward function.
        Args:
            weight: Weight of the loss. Defaults to 1.0.
            ignore_index: Labels to ignore when computing the loss. Default: 255
