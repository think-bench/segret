_base_ = [
    ...
    '../../_base_/datasets/coco_stuff10k_512×512.py',
...
model = dict(
    type='EncoderDecoder',
    pretrained='pretrained/RMT_T_pre.pth',
    backbone=dict(
        type='RMT_T',
        norm_layer=norm_cfg),
    decode_head=dict(
    ...
    train_cfg=dict(),
    # mode='slide', crop_size=(512, 512), stride=(341, 341)  mode='whole'
...
optimizer = dict(_delete_=True, type='AdamW', lr=0.0002, betas=(0.9, 0.999), weight_decay=0.0001,
