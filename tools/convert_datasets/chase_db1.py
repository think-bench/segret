...
def parse_args():
    ...
    parser.add_argument('--dataset_path', default='data/CHASEDB1.zip', help='path of CHASEDB1.zip')
    parser.add_argument('--tmp_dir', help='path of the temporary directory')
    parser.add_argument('-o', '--out_dir', default='data/CHASE_DB1', help='output path')
